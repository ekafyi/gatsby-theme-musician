...
<p className="text-center">
  This paragraph is centered using <code>className="text-center"</code>{" "}
  attribute.
</p>

<p className="text-right">
  And this paragraph is aligned right using <code>className="text-right"</code>{" "}
  attribute.
</p>

<div className="text-center">
  Other than paragraphs, these class names also work with the <code>{`<div>`}</code>{" "}
  element.
</div>
...
<figure>
  ...
  <figcaption>
    Photo © Eka 2019 |{" "}
    <a href="https://github.com/ekafyi/gatsby-theme-musician">Source</a>
  </figcaption>
</figure>
...
<a href="#" className="gtm-button">
  Button link
</a> &nbsp; <a href="#" className="gtm-button-primary">
  Primary button link
</a> &nbsp; <a href="#" className="gtm-button-invert">
